...
func TestHubProductContractIsExplicitAndStable(t *testing.T) {
	...
	expected := map[string]contractOp{
		...
		"workflow.list /v1/workflow-templates":                     {Action: "workflow.list", Method: "GET", Path: "/v1/workflow-templates", Scope: "workflows:read"},
		"workflow.create /v1/workflow-templates/{templateID}/runs": {Action: "workflow.create", Method: "POST", Path: "/v1/workflow-templates/{templateID}/runs", Scope: "workflows:write"},
